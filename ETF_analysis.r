...
ROBO.STOX = matrix(scan("data/ROBO.STOX.csv", what=numeric()), nrow=261) 
SPASIA50 = matrix(scan("data/SPASIA50.csv", what=numeric()), nrow=261)
RBAAIR = matrix(scan("data/RBAAIR.csv", what=numeric()), nrow=261)
DJUSTC = matrix(scan("data/DJUSTC.csv", what=numeric()), nrow=261)
MSCI = matrix(scan("data/MSCI.csv", what=numeric()), nrow=261)
